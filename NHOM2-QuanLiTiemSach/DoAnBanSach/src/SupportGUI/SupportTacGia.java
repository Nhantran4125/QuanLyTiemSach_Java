 ...
 * @author acer
 */
public class SupportTacGia extends JFrame {
    ...
    public SupportTacGia(String text) {//String text
...
//        header.add("Số ĐT");
        ...
        for (TacGiaDTO tg : TacGiaBUS.dstacgia) {
...
//        cb.setBorder(border);
        ...
        chon.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                {
                    SachGUI.txtg.setText(new DuyetTraMaBUS().TraMa(table));
                    setVisible(false);
                }
...
//        SupportTacGia tg=new SupportTacGia("SanPham");
//    }
}
